...
<section className="our-story-section">
  <div className="story-content">
    ...
    <img src="/images/Our-story.png" alt="Our Story" id="story-img" />
  </div>
</section>
...
<section className="our-advantage">
  ...
  <div className="advantage-grid">
    ...
    <div className="advantage-card">
      <img src="/images/tech-driven.png" className="advantage-img tech" />
    ...
    <FadeInWhenVisible delay={0.5}>
    <div className="advantage-card">
      <img src="/images/Eco Friendly.png" className="advantage-img eco" />
    ...
    <div className="advantage-card">
      <img src="/images/Pro Team.png" className="advantage-img trained" />
    ...
    <div className="advantage-card">
      <img src="/images/customer care.png" className="advantage-img flexible" />
    ...
    <div className="advantage-card">
      <img src="/images/customer centric.png" className="advantage-img customer" />
  ...
  <div className="maverick-cards">
    ...
    <div className="maverick-card">
      <img src="/images/Lateef headshot.png" className="maverick-img placeholder-img" />
    ...
    <FadeInWhenVisible delay={0.5}> 
    <div className="maverick-card">
      <img src="/images/Tolulope headshot.png" className="maverick-img placeholder-img" />
    ...
    <FadeInWhenVisible delay={0.7}>
    <div className="maverick-card">
      <img src="/images/Kikelomo Headshot.png" className="maverick-img placeholder-img" />
